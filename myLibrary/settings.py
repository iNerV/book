...
SECRET_KEY = '9gs4%+9ce806q@m6)1jpjpjf2l2vq96n%x4ylcfc0c6witpwgo'
...
MEDIA_ROOT = r'C:\Users\NerV\PycharmProjects\myLibrary\media'  # FIXME не забыть поменять при заливке на боевой
